...
public class ListDemandeReservation extends BaseForm {
    
    

    public ListDemandeReservation(Resources res) {
        ...
        Button popular = new Button("fidels ");
        
        popular.setUIID("SelectBar");
       Button myFavorite = new Button("Top 3");
      
       myFavorite.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(4, demande ,reservation,myFavorite,popular ),
     ...
     popular.getAllStyles().setFont(largeBoldSystemFont);
      ...
      connectionRequest.setUrl("http://localhost/script/ListDemandeByTitre.php");
        ...
        CrudRservation  fc = new CrudRservation ();
               ...
               for(Resrevation f : l){
                    ...
                    Container cnt = new Container();
                     Button b = new Button ();
                    Container cnt1 = addButton(res.getImage("log.png"),"                        "+ f.getTitre(),"Cette chambre a  "+f.getPrenom()+" demande non traite",b,cnt,f.getId_r(),res);
   ...
   private Container  addButton(Image img, String title ,String et ,Button image,Container cnt,int id ,Resources res ) {
       ...
       image = new  Button(img.fill(width, height));
         image.addActionListener((evt) -> {
              Form form = Display.getInstance().getCurrent();
                      form.removeAll();
                     ReservationfeedForm r = new ReservationfeedForm(res, id);
                     r.show();
