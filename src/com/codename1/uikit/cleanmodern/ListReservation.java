...
public class ListReservation extends BaseForm {
    ...
    public ListReservation(Resources res , int id) {
        ...
        tb.setBackCommand("", e -> new ListReservationByTitre(res).show());
      ...
      connectionRequest.setUrl("http://localhost/script/ListReservation.php?id=" +id);
       ...
       connectionRequest.addResponseListener(new ActionListener() {
        ...
        CrudRservation  fc = new CrudRservation ();
               ...
               for(Resrevation f : l){
                    ...
                    Container cnt1 = addButton(res.getImage("log.png"), "                        "+ f.getTitre(),"reserver par "+f.getNom()+" "+f.getPrenom(),"de "+f.getDateDebut()+" jusq'au "+f.getDateFin(),cnt);
   ...
   private Container  addButton(Image img, String title , String date , String date1 ,Container cnt ) {
...
Label datee = new Label(date);
 ...
 Label dateFin = new Label(date1);
       
        dateFin .getAllStyles().setFont(smallBoldProportionalFont);   
