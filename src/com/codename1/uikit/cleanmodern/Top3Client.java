...
public class Top3Client extends BaseForm {
    
    

    public Top3Client(Resources res) {
     ...
     popular.getAllStyles().setFont(largeBoldSystemFont);
      ...
      connectionRequest.setUrl("http://localhost/script/Top3Client.php");
       ...
       connectionRequest.addResponseListener(new ActionListener() {
        ...
        CrudRservation  fc = new CrudRservation ();
               ArrayList<Resrevation> l =fc.getTop3Client(new String(connectionRequest.getResponseData()));
               
               for(Resrevation f : l){
                   
                    Container cnt = new Container();
                     
                    Container cnt1 = addButton(res.getImage("user.png"),"      "+ f.getTitre()+" "+f.getPrenom(),"Ce Client est reservee "+f.getNom()+" fois",cnt);
